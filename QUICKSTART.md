...
## 9. List registered agents

```text
a2a_list()
```

Shows all configured agents in the fleet registry with their names, URLs, and descriptions.

## 10. Cancel tasks

Cancel a remote A2A agent task:
...
Cancel a local Hermes worker subprocess:
